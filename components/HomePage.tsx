    ...
    <div className="max-w-fit mx-auto h-screen w-screen flex bg-gradient-to-r from-blue-700 via-blue-800 to-gray-900">
      ...
      <div className="w-1/2  ">
        ...
        <div className="ml-10 bg-blue-200 rounded-md bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-10 border-0 border-gray-100 flex-col justify-center mt-56 p-10">
          ...
          <p className="text-xl text-left mt-8 ml-10 text-white">
            {"⮕"} Codezen 
          </p>
          <p className="text-xl text-left mt-4 ml-10 text-white">
            {"⮕"} Codezen 
          </p>
          <p className="text-xl text-left mt-4 ml-10 text-white">
            {"⮕"} Wanna be part of amazing journey ??
          </p>
          <button className="transition ease-in-out delay-150 bg-blue-800 hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 duration-300 mt-10 ml-10 h-10 w-32 rounded-xl text-white font-bold text-xl bg-sky-500/100">
            Join
          </button>
        </div>
      </div>
